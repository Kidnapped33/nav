...
var xObject = JSON.parse(x); //把字符串变成对象parse()

var hashMap = xObject || [//如果xObject就用xObject，不存在就用默认的数组
{
  logo: 'A',
  url: 'https://acfun.cn'
}, {
...
$('.addButton').on('click', function () {
  ...
  console.log(url); // console.log($siteList)
...
//# sourceMappingURL=main.2b0287bb.js.map